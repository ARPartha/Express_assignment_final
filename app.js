...
app.get('/all/:country/:city', apiLimiter, function(req, res) {
                    ...
                    if (error) {
                        ...
                        if (searchcountry.toLowerCase() == tergetcountry.toLowerCase()) {
                            ...
                            const wdata = {
                                ...
                                "mintempin_c": (min_temp_c / 3).toFixed(2),
                                "maxtempin_c": (max_temp_c / 3).toFixed(2),
                                "avaragetempin_c": (avg_temp_c / 3).toFixed(2),
                                "mintempin_f": (min_temp_f / 3).toFixed(2),
                                "maxtempin_f": (max_temp_f / 3).toFixed(2),
                                "avaragetempin_f": (avg_temp_f / 3).toFixed(2)
                            };
                            currentweather.push(wdata);
                            ...
                            res.render("index", {
                                city: data.location.name,
                                country: data.location.country,
                                mintempin_c: (min_temp_c / 3).toFixed(3),
                                maxtempin_c: (max_temp_c / 3).toFixed(3),
                                avaragetempin_c: (avg_temp_c / 3).toFixed(3),
                                mintempin_f: (min_temp_f / 3).toFixed(3),
                                maxtempin_f: (max_temp_f / 3).toFixed(3),
                                avaragetempin_f: (avg_temp_f / 3).toFixed(3)
                            });
                        } else {
                            res.render('alert');
                        }
