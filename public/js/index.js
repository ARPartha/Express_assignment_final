...
function toggletemp() {
    ...
    if (counter % 2 != 0) {
        ...
        document.getElementById("tooglebutton").innerHTML = "Temp in F <i class='fas fa-temperature-low'></i>"
    } else {
        document.getElementById("tempc").style.display = "block";
        document.getElementById("tempf").style.display = "none";
        console.log("ola");
        document.getElementById("tooglebutton").innerHTML = "Temp in C <i class='fas fa-temperature-low'></i>"
    }
}